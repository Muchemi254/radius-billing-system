        ...
        <div class="panel panel-hovered mb20 panel-primary">
            <div class="panel-heading">
                <div class="btn-group pull-right">
                    ...
                    <a class="btn btn-primary btn-xs" href="{Text::url('hotspot_server/add')}" title="Add Hotspot Server"><span
                            class="ion ion-android-add" aria-hidden="true"></span> {Lang::T('Add Hotspot Server')}</a>
